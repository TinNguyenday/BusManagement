    ...
    <div className="page">
      ...
      <div className="page-header" style={{ marginBottom: 12 }}>
        ...
        <button className="btn btn-outline btn-sm" onClick={() => exportToExcel(filtered, [
          { header: 'ID', key: 'id' },
          { header: 'Tên nhà xe', key: 'companyName' },
          { header: 'Chủ sở hữu', format: (r) => r.owner?.fullName ?? '' },
          { header: 'SĐT', key: 'phone' },
          { header: 'Địa chỉ', key: 'address' },
          { header: 'Trạng thái', format: (r) => ({ PENDING: 'Chờ duyệt', APPROVED: 'Đã duyệt', REJECTED: 'Từ chối' })[r.status] },
        ], 'danh-sach-nha-xe')}>
          📥 Xuất Excel
        </button>
      </div>
